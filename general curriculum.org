* *Ticklers*
** [#A] CANCELED  Put comment about emailing CD immediately after the session with comments into faculty guides.
:LOGBOOK:
...
** DONE [#A] Organize pizza lunch for 9/27
:PROPERTIES:
:ORDERED:  t
:END:
:LOGBOOK:
...
** [[https://entrada.rush.edu/community/rmd57419farmc:discussion_board?section=view-forum&id=56][Check Discussion Board]]
...
** Schedule student lunch for December
SCHEDULED: <2019-11-27 Wed>
** [#A] CANCELED  Talk to Maria about how to get on tag questions
:LOGBOOK:
- Note taken on [2019-07-18 Thu 06:45] \\
  Recent email says we are 100% done.  I'll take their word for it.
:END:
** [#A] CANCELED  Go through quesitons mone more time and make sure everything got tagged.
:LOGBOOK:
...
:END:
** Schedule Faculty-Student Lunch
SCHEDULED: <2019-11-27 Wed>
:PROPERTIES:
...
:END:
:LOGBOOK:
- State "WAITING"    from "TODO"       [2019-11-06 Wed 10:34] \\
  Requested room.  Sent invites.  Waiting to hear from registrar about request, then edit the invite and add the room.
:END:
...
:END:
** What to tell students who wish to miss a required session. Petition for Exemption from Mandatory Attendance Event   [[message://%3cd2ea67a783f244099e899d78ee318fa7@RUPW-EXCHMAIL02.rush.edu%3E][RE: Absence for vital fluids session]]
...
:ID:       64CFD536-0996-4974-8A05-A8F684F26483
:END:
...
** [#A] CANCELED  Tell Carl how to use air media
:LOGBOOK:
...
:END:
** DONE [#A] Take care of reassessments [[message://%3cC9D2CD61-B4F7-48EC-8378-FBEBCA0A5254@rush.edu%3E][M1 & M2 Reassessments]]
:LOGBOOK:
- State "DONE"       from "TODO"       [2019-11-12 Tue 08:17]
:END:

** Arrange student lunch
