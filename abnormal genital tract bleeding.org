...
:END:
** TODO [#A] Make sure that packets re ready to go for AGB activity on 9/3
...
:END:
:LOGBOOK:
- State "WAITING"    from "DONE"       [2019-08-29 Thu 10:50] \\
  Wating on Gary to confirm that he can make it before canceling this.
